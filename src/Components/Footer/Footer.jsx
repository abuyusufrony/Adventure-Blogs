            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold"><Link to={'/'} className="btn btn-ghost   text-xl font-bold mr-4 bg-gradient-to-r from-[#4ade80] via-[#22d3ee] to-[#6366f1] bg-clip-text text-transparent transition-all duration-300 hover:from-[#f472b6] hover:via-[#c084fc] hover:to-[#60a5fa] ">TourLand</Link></span>
                    </a>
                </div>
